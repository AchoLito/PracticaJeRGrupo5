class EditarContrasena2 extends Phaser.Scene
{
    constructor()
    {
        super({ key: "EditarContrasena2"}); 
    }

    preload()
    {
        this.load.html("edit2", "html/EditPassword2.html");
    ...
    create()
    {
        ...
        const botonVolver = this.add.image(75, 75, "botonVolver")
            ...
            .on("pointerdown", () => {
                ...
                this.scene.stop("EditarContrasena2");
                this.scene.start("MenuAjustes2");
            });
        ...
        const formulario = this.add.dom(590, 400).createFromCache('edit2');
